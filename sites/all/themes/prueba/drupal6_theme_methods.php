...
function prueba_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function prueba_feed_icon($url, $title) {
 ...
 */
function prueba_preprocess_comment_wrapper(&$vars) {
 ...
 */
function prueba_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb art-postcontent">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function prueba_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function prueba_button($element) {
...
*/
function prueba_img_assist_page($content, $attributes = NULL) {
 ...
 * @ingroup themeable
 */
function prueba_node_preview($node) {
