...
function prueba_process_html(&$variables) {
...
function prueba_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function prueba_button($variables) {
 ...
 */
function prueba_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function prueba_menu_local_task($variables) {
 ...
 */
function prueba_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function prueba_node_preview($variables) {
  $node = $variables['node'];
