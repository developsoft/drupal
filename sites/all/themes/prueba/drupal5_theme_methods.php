 ...
 * @ingroup themeable
 */
function prueba_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 */
function prueba_comment_wrapper($content, $type = null) {
  static $node_type;
